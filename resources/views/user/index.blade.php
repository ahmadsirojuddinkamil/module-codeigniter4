...
<body>
    ...
    <div class="container mt-5">
        <table class="table border">
            ...
            <a href="/user/create" type="button" class="btn btn-success mb-3">Create User</a>
            ...
            <tbody>
                @foreach ($getAllUser as $user)
                    <tr>
                        ...
                        <td>{{ $user->email }}</td>
                        <td>
                            <a href="/user/{{ $user->uuid }}" class="badge bg-warning">
                                <i class="fas fa-portrait text-white"></i>
                            </a>

                            <a href="/user/edit/{{ $user->uuid }}" class="badge bg-primary">
                            ...
                            <div class="modal fade" id="exampleModal{{ $user->uuid }}" tabindex="-1"
